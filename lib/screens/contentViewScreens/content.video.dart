...
import '../../providers/provider.data.dart';
...
class VideoContentView extends StatefulWidget {
  ...
  @override
  VideoContentViewState createState() => VideoContentViewState();
}

class VideoContentViewState extends State<VideoContentView> with SingleTickerProviderStateMixin {
  //
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                        currrentPosition < 10 ? '0:0$currrentPosition' : '0:$currrentPosition',
                      ...
                      Text(
                        videoLength.inSeconds < 10 ? '0:0${videoLength.inSeconds}' : '0:${videoLength.inSeconds}',
                        style: const TextStyle(color: Colors.white),
                      ),
                    ],
                  ),
