...
class _BackdropPanelState extends State<BackdropPanel> {
  ...
  Widget build(BuildContext context) {
    final _dataStatus = context.watch<DataProvider>().dataStatus;
    final _toggleAppMode = context.read<DataProvider>().toggleStatusMode;
    final _permissionGranted = context.watch<PermissionProvider>().permissionStatus.isGranted;
      ...
      children: <Widget>[
        ...
        Padding(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
              ...
              const Text('SakaDevs Inc © 2020  App made with Flutter', style: TextStyle(color: Colors.black87))
            ])),
      ],
    );
  }
